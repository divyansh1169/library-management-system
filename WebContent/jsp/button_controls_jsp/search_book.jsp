...
<body   >
<h1 align="center" style=color:#F3CF2B ;font-style: oblique;">SEARCH BOOK_________</h1>
<div id="id">
<table  align="center"  >
<tr>
			...
			<td>
			<form action="/library_project/jsp/button_controls_jsp/search_book.jsp" method="post">
...
<%@ page import="oracle.jdbc.driver.OracleDriver" %>
 ...
 <%
  	String title="",auther_name="",publisher="",category="",pur_date="",branch="",comment="",book_id="";; 
...
<table border="" class="container">
		...
		<tr>
			...
			<br>
				<input type="reset"  id="back"  onclick="window.history.back();" value="Back" style="width:25%;color:white; border-radius:20px; background:#76906E"> 
