...
<a href="issue_return_book.jsp" target="dynamic_page"><input type="button" value="Issue / Return" ></a><br><br>
<a href="calculate_fine.jsp" target="dynamic_page"><input type="button" value="Calculate Fine" ></a><br><br>
